      ...
      <div className="min-h-screen pb-32">
        ...
        <div style={{ padding: '24px', marginTop: '-12px' }}>
          <div className="space-y-4">
            {/* Confidence Badge */}
            <div className="card" style={{
              background: ocrResult.confidence >= 80 ? '#D1FAE5' : 'var(--color-verify-bg)',
              border: `2px solid ${ocrResult.confidence >= 80 ? '#A7F3D0' : '#FDE68A'}`,
              padding: '16px',
              display: 'flex',
              alignItems: 'center',
              gap: '12px'
            ...
            {/* Medications */}
            <div className="card">
              <h3 style={{ marginBottom: '16px' }}>확인된 약물 ({ocrResult.medications.length}개)</h3>
                ...
                {ocrResult.medications.map((med, idx) => (
                  <div 
                    ...
                    style={{
                      ...
                      borderRadius: '14px',
                      border: med.confidence < 80 ? '2px solid #FDE68A' : '2px solid transparent'
                    }}
                  >
                    <div style={{ 
                      display: 'flex', 
