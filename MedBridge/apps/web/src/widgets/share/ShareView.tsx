    ...
    <div className="min-h-screen pb-8">
      ...
      <div className="px-6 py-8">
        ...
        <div className="card" style={{
          padding: '20px',
          marginBottom: '24px',
          background: timeLeft < 60 ? 'var(--color-alert-bg)' : 'var(--color-surface)'
        }}>
          <div style={{
            display: 'flex',
            alignItems: 'center',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <Clock className="w-5 h-5" style={{ 
                color: timeLeft < 60 ? 'var(--color-alert)' : 'var(--color-text-secondary)' 
              }} />
              <span style={{ 
                color: timeLeft < 60 ? 'var(--color-alert)' : 'var(--color-text-primary)'
              }}>
                남은 시간
              </span>
            </div>
            <span style={{ 
              ...
              color: timeLeft < 60 ? 'var(--color-alert)' : 'var(--color-accent)'
            }}>
              {formatTime(timeLeft)}
            </span>
          </div>
        ...
        <div style={{
          ...
          <ul style={{
            ...
            <li style={{ marginBottom: '8px' }}>• 10분 안에는 여러 번 볼 수 있어요</li>
            <li style={{ marginBottom: '8px' }}>• 새 코드를 받으면 이전 코드는 사용할 수 없어요</li>
