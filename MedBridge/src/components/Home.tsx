    ...
    <div className="min-h-screen pb-24">
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ flex: 1, opacity: 0.9 }}>내 약 기록 {recordCount}건</span>
        </div>
      </div>
      ...
      <div style={{ padding: '24px', marginTop: '12px' }}>
        <div style={{
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 8px 16px rgba(40, 91, 170, 0.12)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = 'translateY(0)';
              e.currentTarget.style.boxShadow = '0 2px 8px rgba(40, 91, 170, 0.06)';
            }}
          >
        ...
        <div className="card-gradient" style={{ marginBottom: '20px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '16px' }}>
            ...
            <div style={{ flex: 1 }}>
              <p style={{ fontSize: '0.875rem', opacity: 0.9, marginBottom: '2px' }}>
                등록된 처방 기록
              </p>
